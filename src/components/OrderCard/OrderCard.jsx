...
import {company_emails, GRAVYNOTE, PLACES, STATUS} from '@/utils/constants';
...
import {DELIVERYORDER, ORDERS} from '@/utils/routes';
                            ...
                            {user.email === process.env.NEXT_PUBLIC_ADMIN_EMAIL && (
                                <>
                                    ...
                                    <div className={'flex justify-end items-start gap-1 mt-3'}>
                                        ...
                                        }} className={'p-2 bg-blue-700 rounded-lg text-white w-40'}>Edit
                                        </button>
                                    </div>
                                </>
                            )}
