            ...
            <div className={styles.gridcontainer}>
                ...
                <div className={styles.column}>
                    ...
                    <ul className={styles.list}>
                        ...
                        <li>
                            ලබා දෙන මුදලට උපරිම සාධාරණයක් ඉටු කරමින් ප්‍රණීත ආහර වේලක් ලබා දීමෙ අරමුනින් අප දිනකට අඩු
                        ...
                        <li>භාර ගන්නා ලද සියලුම ඇමතුම් රාත්‍රී 7.30 ත් 8.30ත් අතර කාලයේ දී විශ්ව විද්‍යාලීය ප්‍රධාන ගේට්ටුව
