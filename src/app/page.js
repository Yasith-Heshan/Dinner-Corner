            ...
            <div className={styles.gridcontainer}>
                ...
                <div className={styles.column}>
                    ...
                    <ul className={styles.list}>
                        ...
                        <li>නමුත් ව්‍යාපාරයේ දියුණුවත් සමඟ භාර ගන්නා ඇනවුම් ධාරිටතාවය ඉහල දමනු ඇත. </li>
                        <li><span className={styles.specialNote}>දිනක උපරිම ඇනවුම් ධාරිතාවය ඉක්මවා ඇති විටක තව දුරටත් ඇනවුම් භාර ගැනීම ස්වයන්ක්‍රීයව අක්‍රිය වේ.</span></li>
                        <li><span className={styles.specialNote}>මෙම සේවාව 17/06/2023 දින සිට ක්‍රියාත්මක වේ.</span> </li>
                        ...
                        <li>අප ආයතනය මගින් <span className={styles.specialNote}>රාත්‍රී ආහාර වේල් පමණක්</span> සපයන අතර
                            පස්වරු 2:30ට පෙර ඇනවුම් කිරීමට කාරුණික වන්න.
                        </li>
                        <li>ඇනවුමක් භාරගත් පසු අප ආයතනය ඔබට ඇනවුම තහවුරු කිරීමට දුරකතන ඇමතුමක් ලබා දෙනු ඇත.</li>
                        <li>භාර ගන්නා ලද සියලුම ඇමතුම් රාත්‍රී 7 ත් 8ත් අතර කාලයේ දී විශ්ව විද්‍යාලීය ප්‍රධාන ගේට්ටුව
                        ...
                        <li>විමසීම් සඳහා:
                            <ul>
                                <li>0712079518 - රේණුකා පෙරේරා - මොරටුව විශ්ව විද්‍යාලය සඳහා</li>
                                <li>0716870170 - තිළිණි පෙරේරා - ශ්‍රී ජයවර්ධනපුර විශ්ව විද්‍යාලය සඳහා</li>
                            </ul>
                        </li>
                    </ul>
                </div>
